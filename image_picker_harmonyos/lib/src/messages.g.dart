...
class ImagePickerApi {
  ...
  Future<List<String>> pickImages(
      SourceSpecification argSource,
      ImageSelectionOptions argOptions,
      GeneralOptions argGeneralOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickImages', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[argSource, argOptions, argGeneralOptions])
            as List<Object?>?;
    if (replyList == null) {
  ...
  Future<List<String>> pickVideos(
      SourceSpecification argSource,
      VideoSelectionOptions argOptions,
      GeneralOptions argGeneralOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  /// Elements must not be null, by convention. See
  /// https://github.com/flutter/flutter/issues/97848
  Future<List<String>> pickMedia(MediaSelectionOptions argMediaSelectionOptions,
      GeneralOptions argGeneralOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickMedia', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel
            .send(<Object?>[argMediaSelectionOptions, argGeneralOptions])
        as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',

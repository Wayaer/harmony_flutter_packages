...
/// An implementation of [UrlLauncherPlatform] for Ohos.
class UrlLauncherHarmonyOS extends UrlLauncherPlatform {
  /// Creates a new plugin implementation instance.
  UrlLauncherHarmonyOS({
  ...
  static void registerWith() =>
      UrlLauncherPlatform.instance = UrlLauncherHarmonyOS();
  ...
  // so that it works on strings that aren't actually valid URLs, since Ohos

...
export 'package:shared_preferences_platform_interface/shared_preferences_platform_interface.dart';
...
class SharedPreferencesHarmonyOS extends SharedPreferencesStorePlatform {
  /// Creates a new plugin implementation instance.
  SharedPreferencesHarmonyOS({
  ...
  static void registerWith() {
    SharedPreferencesStorePlatform.instance = SharedPreferencesHarmonyOS();
  }

  static const String _defaultPrefix = 'flutter.';
  static const String _doublePrefix =
  ...
  Future<Map<String, Object>> getAllWithParameters(
    ...
    data = data.map((key, value) {
      if (value is String && value.startsWith(_doublePrefix)) {
        return MapEntry(
            key, double.tryParse(value.substring(_doublePrefix.length)));
      }

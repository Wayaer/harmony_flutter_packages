...
class WebSettingsHostApi {
  ...
  Future<void> setAllowFullScreenRotate(
      int arg_instanceId, bool arg_enabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_response != null,
              'Argument for dev.flutter.pigeon.webview_flutter_ohos.WebViewClientFlutterApi.onReceivedHttpError was null, expected non-null WebResourceResponseData.');
